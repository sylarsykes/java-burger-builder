...
import static org.sylrsykssoft.java.springboot.mealbuilder.api.configuration.meals.SaladApiConstants.SALAD_SIZE_COLUMN;
...
@Table(name = REPOSITORY_SALAD_TABLE_NAME, schema = MEAL_SCHEMA_NAME, catalog = MEAL_SCHEMA_NAME, uniqueConstraints = {
		@UniqueConstraint(columnNames = { SALAD_SIZE_COLUMN, BASE_NAME_MODEL_NAME_NAME_COLUMN }) })

/**
 * LocalizedDescriptionCocktail.java 15 mar. 2021
 *
 */
...
import static org.sylrsykssoft.java.springboot.mealbuilder.api.configuration.drinks.CocktailApiConstants.REPOSITORY_LOCALIZED_DESCRIPTION_COCKTAIL_ENTITY_NAME;
import static org.sylrsykssoft.java.springboot.mealbuilder.api.configuration.drinks.CocktailApiConstants.REPOSITORY_LOCALIZED_DESCRIPTION_COCKTAIL_TABLE_NAME;
...
/**
 * LocalizedDescriptionCocktail
 * 
 * @author juan.gonzalez.fernandez.jgf
 *
 */
@Table(name = REPOSITORY_LOCALIZED_DESCRIPTION_COCKTAIL_TABLE_NAME, schema = DRINK_SCHEMA_NAME, catalog = DRINK_SCHEMA_NAME, uniqueConstraints = {
...
@Entity(name = REPOSITORY_LOCALIZED_DESCRIPTION_COCKTAIL_ENTITY_NAME)
...
public class LocalizedDescriptionCocktail extends BaseEmbeddedLocalizedValueModel<LocalizedFieldNameModel> {

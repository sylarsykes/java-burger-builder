...
import org.sylrsykssoft.springboot.common.api.model.embeddable.BaseEmbeddedNameModel;
 ...
 *
 */
@Table(name = REPOSITORY_LOCALIZED_DRINK_TABLE_NAME, schema = DRINK_SCHEMA_NAME, catalog = DRINK_SCHEMA_NAME)
...
public class LocalizedDrink extends BaseEmbeddedNameModel<LocalizedModel> {

/**
 * SandwichIngredientDTO.java 11 mar. 2021
 *
 */
...
@Schema(name = "SandwichIngredientDTO", description = "Model SandwichIngredientDTO")
public class SandwichIngredientDTO extends BaseModelDTO<Integer> implements Serializable {

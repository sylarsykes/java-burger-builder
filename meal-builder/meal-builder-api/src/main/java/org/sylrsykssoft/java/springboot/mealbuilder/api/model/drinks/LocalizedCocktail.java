/**
 * LocalizedCocktail.java 15 mar. 2021
 *
 */
...
import static org.sylrsykssoft.java.springboot.mealbuilder.api.configuration.drinks.CocktailApiConstants.REPOSITORY_LOCALIZED_COCKTAIL_ENTITY_NAME;
import static org.sylrsykssoft.java.springboot.mealbuilder.api.configuration.drinks.CocktailApiConstants.REPOSITORY_LOCALIZED_COCKTAIL_TABLE_NAME;
 ...
 *
 */
@Table(name = REPOSITORY_LOCALIZED_COCKTAIL_TABLE_NAME, schema = DRINK_SCHEMA_NAME, catalog = DRINK_SCHEMA_NAME, uniqueConstraints = {
...
@Entity(name = REPOSITORY_LOCALIZED_COCKTAIL_ENTITY_NAME)
...
public class LocalizedCocktail extends BaseEmbeddedLocalizedValueModel<LocalizedFieldNameModel> {

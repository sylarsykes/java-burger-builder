/**
 * BurgerCategoryDTO.java 11 mar. 2021
 *
 */
...
@Schema(name = "BurgerCategoryDTO", description = "Model BurgerCategoryDTO")
public class BurgerCategoryDTO extends BaseModelDTO<Integer> implements Serializable {

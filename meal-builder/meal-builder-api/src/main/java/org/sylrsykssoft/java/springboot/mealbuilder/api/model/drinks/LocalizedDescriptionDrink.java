...
import static org.sylrsykssoft.java.springboot.mealbuilder.api.configuration.drinks.DrinkApiConstants.REPOSITORY_LOCALIZED_DESCRIPTION_DRINK_ENTITY_NAME;
import static org.sylrsykssoft.java.springboot.mealbuilder.api.configuration.drinks.DrinkApiConstants.REPOSITORY_LOCALIZED_DESCRIPTION_DRINK_TABLE_NAME;
 ...
 *
 */
@Table(name = REPOSITORY_LOCALIZED_DESCRIPTION_DRINK_TABLE_NAME, schema = DRINK_SCHEMA_NAME, catalog = DRINK_SCHEMA_NAME, uniqueConstraints = {
...
@Entity(name = REPOSITORY_LOCALIZED_DESCRIPTION_DRINK_ENTITY_NAME)
...
public class LocalizedDescriptionDrink extends BaseEmbeddedLocalizedValueModel<LocalizedFieldNameModel> {

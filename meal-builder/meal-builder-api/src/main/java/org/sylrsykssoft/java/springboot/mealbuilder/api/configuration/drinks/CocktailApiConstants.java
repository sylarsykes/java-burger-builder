...
import static org.sylrsykssoft.java.springboot.mealbuilder.api.configuration.ApiConstants.REPOSITORY_LOCALIZED_PREPARATION_ENTITY_NAME;
import static org.sylrsykssoft.java.springboot.mealbuilder.api.configuration.ApiConstants.REPOSITORY_LOCALIZED_PREPARATION_TABLE_NAME;
...
public class CocktailApiConstants {
	...
	// LOCALIZED COCKTAIL //
	public static final String REPOSITORY_LOCALIZED_NAME_COCKTAIL_TABLE_NAME = REPOSITORY_LOCALIZED_NAME_TABLE_NAME
			+ REPOSITORY_COCKTAIL_TABLE_NAME;
	public static final String REPOSITORY_LOCALIZED_NAME_COCKTAIL_ENTITY_NAME = REPOSITORY_LOCALIZED_NAME_ENTITY_NAME
			+ REPOSITORY_COCKTAIL_ENTITY_NAME;
	public static final String REPOSITORY_LOCALIZED_DESCRIPTION_COCKTAIL_TABLE_NAME = REPOSITORY_LOCALIZED_DESCRIPTION_TABLE_NAME
			+ REPOSITORY_COCKTAIL_TABLE_NAME;
	public static final String REPOSITORY_LOCALIZED_DESCRIPTION_COCKTAIL_ENTITY_NAME = REPOSITORY_LOCALIZED_DESCRIPTION_ENTITY_NAME
			+ REPOSITORY_COCKTAIL_ENTITY_NAME;
	public static final String REPOSITORY_LOCALIZED_PREPARATION_COCKTAIL_TABLE_NAME = REPOSITORY_LOCALIZED_PREPARATION_TABLE_NAME
			+ REPOSITORY_COCKTAIL_TABLE_NAME;
	public static final String REPOSITORY_LOCALIZED_PREPARATION_COCKTAIL_ENTITY_NAME = REPOSITORY_LOCALIZED_PREPARATION_ENTITY_NAME
			+ REPOSITORY_COCKTAIL_ENTITY_NAME;

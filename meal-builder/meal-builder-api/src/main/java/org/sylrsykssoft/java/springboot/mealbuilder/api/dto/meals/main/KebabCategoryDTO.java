/**
 * KebabCategoryDTO.java 11 mar. 2021
 *
 */
...
@Schema(name = "KebabCategoryDTO", description = "Model KebabCategoryDTO")
public class KebabCategoryDTO extends BaseModelDTO<Integer> implements Serializable {

/**
 * LocalizedPreparationCocktail.java 15 mar. 2021
 *
 */
...
import static org.sylrsykssoft.java.springboot.mealbuilder.api.configuration.drinks.CocktailApiConstants.REPOSITORY_LOCALIZED_PREPARATION_COCKTAIL_ENTITY_NAME;
import static org.sylrsykssoft.java.springboot.mealbuilder.api.configuration.drinks.CocktailApiConstants.REPOSITORY_LOCALIZED_PREPARATION_COCKTAIL_TABLE_NAME;
...
/**
 * LocalizedPreparationCocktail
 * 
 * @author juan.gonzalez.fernandez.jgf
 *
 */
@Table(name = REPOSITORY_LOCALIZED_PREPARATION_COCKTAIL_TABLE_NAME, schema = DRINK_SCHEMA_NAME, catalog = DRINK_SCHEMA_NAME, uniqueConstraints = {
...
@Entity(name = REPOSITORY_LOCALIZED_PREPARATION_COCKTAIL_ENTITY_NAME)
...
public class LocalizedPreparationCocktail extends BaseEmbeddedLocalizedValueModel<LocalizedFieldNameModel> {
